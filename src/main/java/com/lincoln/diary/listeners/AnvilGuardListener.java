...
import org.bukkit.event.inventory.PrepareAnvilEvent;   // ✅ correct event class
...
public class AnvilGuardListener implements Listener {
    ...
    public void onPrepare(PrepareAnvilEvent e) {         // ✅ correct event name
        AnvilInventory inv = e.getInventory();           // ✅ exists on PrepareAnvilEvent
        ...
        if ((left != null && DiaryItem.isDiary(left)) || (right != null && DiaryItem.isDiary(right))) {
            e.setResult(null);                           // ✅ valid on PrepareAnvilEvent
        }
    }
    ...
    public void onClick(InventoryClickEvent e) {
        ...
        ItemStack current = e.getCurrentItem();          // ✅ method exists
