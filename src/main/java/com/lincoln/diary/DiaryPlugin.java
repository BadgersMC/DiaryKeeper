package com.lincoln.diary;

import com.lincoln.diary.commands.DiaryCommand;
import com.lincoln.diary.config.ConfigManager;
import com.lincoln.diary.data.DiaryStore;
import com.lincoln.diary.logic.DeliveryService;
import com.lincoln.diary.logic.DuplicateWatcher;
import com.lincoln.diary.logic.VoidWatcher;
import com.lincoln.diary.listeners.*;
    ...
    public void onEnable() {
        ...
        if (main != null) {
            ...
            if (last == null || !Objects.equals(last, current)) {
                getLogger().warning("World UUID changed or first run — resetting diary registry and queues.");
